...
| 8 | **b)** | `@Override` indicates method overrides interface/superclass method |
...
### Question 7
`calculateTotalWorkload()` would need unique implementation for OnlineCourse because online courses use different metrics (video hours, quizzes) rather than in-person hours.
